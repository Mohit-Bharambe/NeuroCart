  ...
  return (
    ...
    >
      <Link 
        ...
        className="group relative bg-white rounded-3xl p-4 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl border border-gray-100 flex flex-col h-full"
      >
        <div className="relative aspect-square rounded-2xl overflow-hidden bg-gray-100 mb-4">
          ...
          <button 
            ...
            className="absolute top-3 right-3 p-2.5 rounded-full bg-white/80 backdrop-blur hover:bg-white text-gray-600 hover:text-red-500 transition-colors shadow-sm z-10"
          >
        ...
        <div className="flex flex-col flex-1">
          ...
          <div className="mt-auto flex items-center justify-between">
            ...
            <button 
              ...
              className="bg-gray-900 hover:bg-accent text-white p-3 rounded-full transition-colors shadow-md z-10"
            >
